    ...
    return (
        <>
            <div className='flex gap-8 p-20'>
                <div className='py-16'>
                    <div className='border-2 border-gray-200 p-5 w-[40vw] h-[40vh] flex flex-col gap-4 shadow-lg rounded-xl' >
                        <h1>New Customer</h1>
                        ...
                        <button onClick={() => navigate(`/sign-up`)} className=' h-[6vh] w-[12vw] bg-stone-800 text-slate-100 '>CONTINUE</button>
                    </div>
                </div>
                <div className='border-2 border-gray-200 p-5 w-[50vw] h-[60vh] flex flex-col gap-4 shadow-lg rounded-xl'>
